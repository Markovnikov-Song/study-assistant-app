    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
                  ...
                  child: Row(children: [
                    ...
                    Expanded(
                        child: _NumField(
                            ...
                            value: _scores[t]!,
                            onChanged: (v) =>
                                setState(() => _scores[t] = v))),
                  ]),
                )),
            Text('总分：$_totalScore 分',
                style:
          ...
          const SizedBox(height: 8),
          FilledButton.icon(
            onPressed: (state.isLoading || _selected.isEmpty)
                ? null
                : () => ref
                    .read(customQuizProvider(widget.subjectId).notifier)
                    .generate(
